...
def eval_kitti_mots(trackers_to_eval, split, trackers_folder='output/experiments', tracker_sub_folder='mots_files',
                    gt_folder='TrackEval/data/gt/kitti_mots_train'):
    freeze_support()
    ...
    dataset_config['GT_LOC_FORMAT'] = '{gt_folder}/labels/{seq}.txt'
